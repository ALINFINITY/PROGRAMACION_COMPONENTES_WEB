class participante extends HTMLElement{
    ...
    render = (participante) => {
        ...
        this.shadowRoot.querySelector('#participante-form').addEventListener('submit', this.handleSubmit);
    }

    handleDelete = async (id) => {
        const confirmDelete = confirm(`Esta seguro de eliminar el participante con el id ${id}`);
    ...
    handleUpdate = async (id) => {
        ...
        <div class="up-container" >
            ...
            <form id="participante-form">
                ...
                <label >Edad</label>
                <input type="number" id="uedad" name="uedad">
