    ...
    render = (vista) => {
        ...
        <div class="form-container" >
            ...
            <form id="asoc-form">
                ...
                <input type="number" id="idpt" name="idpt">
                
                <label>Ingrese el ID del Proyecto</label>
                <input type="number" id="idpro" name="idpro">
        ...
        this.shadowRoot.querySelector('#asoc-form').addEventListener('submit', this.handleSubmit);
    }

    handleDelete = async (id) => {
        const confirmDelete = confirm(`Esta seguro de eliminar la Asociación con el id ${id}`);
    ...
    handleSubmit = async (event) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert("Error al registrar: " + errorData.message+" o Entidades participantes no definidas");
            }
